...
The internal MARSS model specification (element \verb@$marss@ in a fitted marssMLE object output by a \verb@MARSS()@ call) is a list with the $\ff_t$ (``fixed") and $\DD_t$ (``free") matrices for each parameter.   
