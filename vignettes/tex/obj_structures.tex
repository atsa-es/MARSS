...
Use \verb@is.marssMODEL()@\index{functions!is.marssMODEL} to check whether an marssMODEL object is correctly specified. The MARSS package includes an \verb@as.marxssMODEL()@\index{functions!as.marssMODEL} method to convert objects of class popWrap (see next section) to objects of class marssMODEL. 
