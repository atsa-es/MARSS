...
The argument \verb@model@ specifies the structure of the MARSS model.  It is a list\index{model specification!in MARSS}, where the list elements for each model parameter specifies the form of that parameter.  
