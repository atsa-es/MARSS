...
You might also want to look at the \verb@augment@, \verb@tidy@ and \verb@glance@ functions which will summarize commonly needed output from a MARSS model fit.  Type \verb@?augment.marssMLE@ at the command line to see examples.  These functions work as they do in the \verb@broom@ R package.
...
\end{Sinput}
\end{Schunk}
When you call MARSS, \verb@dat[c("Temp1","Temp2"),]@ are the data and \verb@dat[c("Yr","Month","Sal"),]@ are your covariates.  
