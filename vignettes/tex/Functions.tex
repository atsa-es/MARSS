...
\begin{description}
  ...
  \item[residuals]\verb@MARSSresiduals(MLEobj)@  and \verb@residuals.marssMLE(MLEobj)@. See \verb@?MARSSresiduals@ for a discussion of standardized residuals in the context of MARSS models.\index{functions!residuals}
