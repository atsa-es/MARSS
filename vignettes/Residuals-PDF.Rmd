...
date: 7 Jan 2020
author: 
  - Elizabeth E. Holmes^[Northwest Fisheries Science Center, NOAA Fisheries, Seattle, WA 98112, eli.holmes@noaa.gov]
link-citations: yes
pkgdown:
  as_is: true
  extension: pdf
...
abstract: |
    ...
    citation: Holmes, E. E. 2014. Computation of standardized residuals for (MARSS) models. Technical Report. [arXiv:1411.0045](https://arxiv.org/abs/1411.0045)
vignette: >
  %\VignetteIndexEntry{Residuals-PDF}
...
<!-- \citet{} @key for inline citation name (year); \citep [@key] for citation in parens (name year) -->
...
# Distribution of MARSS smoothation residuals {#sec:smoothations}
...
### Putting together the first and second terms
...
If the residuals are defined as in @Harveyetal1998 with $\hatvt$ on top and $\hatwtp$ on the bottom instead of $\hatwt$, then
\begin{equation}
...
# Distribution of the MARSS innovation residuals
<div style="display:none">$\nextSection$</div>
