...
@
Or you can pass in a MARSS() fit. This is a shortcut for the above call.
...
<<Cs_mci_012>>=
  ...
  fit1=MARSS(dat)
  MCinits = MARSSmcinit(fit1, numInits = 10) 
