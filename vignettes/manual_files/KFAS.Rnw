...
\begin{tabular}{rr|cc}
  \hline
& \multicolumn{6}{c|}{type} & \multicolumn{3}{c|}{standardization}\\
& ytT & ytt & ytt1 & xtT & xtt & xtt1 & none & Cholesky & marginal\\ 
  \hline
\texttt{residuals(kfas_obj, type = "recursive")}&&&X&&&&X&& \\
\texttt{residuals(kfas_obj, type = "pearson")}&&&X&&&&&&X \\
\texttt{residuals(kfas_obj, type = "response")}&X&&&&&&&&X \\
\texttt{residuals(kfas_obj, type = "state")}&&&&X&&&X&& \\
\texttt{rstandard(kfas_fit$model, type = "recursive", standardization_type = "marginal")}&&&X&&&&&&X \\
\texttt{rstandard(kfas_fit$model, type = "recursive", standardization_type = "cholesky")}&&&X&&&&&X& \\
\texttt{rstandard(kfas_fit$model, type = "pearson", standardization_type = "marginal")}&X&&&&&&&&X \\
\texttt{rstandard(kfas_fit$model, type = "pearson", standardization_type = "cholesky")}&X&&&&&&&X& \\
\texttt{rstandard(kfas_fit$model, type = "state", standardization_type = "marginal")}&&&&X&&&&&X \\
\texttt{rstandard(kfas_fit$model, type = "state", standardization_type = "cholesky")}&&&&X&&&&X& \\
\end{tabular} 
\end{center}
\end{table}
\bigskip
