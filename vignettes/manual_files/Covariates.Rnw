...
for(i in 1:3) {
  ...
  for(j in 1:5) {
    ...
    acf(residuals(modn)$model.residuals[j,], na.action=na.pass)
    }
  }
@
...
for(i in 1:5) {
  ...
  acf(residuals(seas.mod.1)$model.residuals[i,], lag.max=period, na.action=na.pass)
  if(i==5) {
...
for(i in 1:5) {
  ...
  acf(residuals(seas.mod.2)$model.residuals[i,], lag.max=period, na.action=na.pass)
  if(i==5) {
       axis(1, at=c(0,seq(period)))
       mtext(side=1, line=2.7, "Time lag")
     }
...
for(i in 1:5) {
  ...
  acf(residuals(seas.mod.3)$model.residuals[i,], lag.max=period, na.action=na.pass)
  if(i==5) {
       axis(1, at=c(0,seq(period)))
       mtext(side=1, line=2.7, "Time lag")
     }
