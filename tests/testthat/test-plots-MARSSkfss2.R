...
context("MARSSkfss versus MARSSkfas residuals plots")

#this code produces many fails, esp for residuals
#but none look bad
# testthat::snapshot_review('plots-MARSSkfss2')
...
library(ggplot2)
plottypes <- c(
  "qqplot.std.model.resids.ytt1", "acf.std.model.resids.ytt1",
