###################################################
### code chunk number 2: Cs_00_required_libraries
###################################################
library(MARSS)
...
V=matrix(0,2,2)
model.list.2=list(Z=Z,B=B,U=U,Q=Q,A=A,R=R,x0=mu,V0=V,tinitx=0)
...
###################################################
### code chunk number 10: Cs_05_arima
###################################################
arima(gappy.data,order=c(2,0,0),include.mean=FALSE)


###################################################
### code chunk number 11: Cs_05b_non-stationary
###################################################
TT=50
true.2=c(r=0,b1=-1.5,b2=-0.75,q=1)
sim.ar2.ns=rep(NA,TT)
sim.ar2.ns[1]=-30; sim.ar2.ns[2]=-10
for(i in 3:TT)
  sim.ar2.ns[i]=true.2[2]*sim.ar2.ns[i-1]+true.2[3]*sim.ar2.ns[i-2]+rnorm(1,0,sqrt(true.2[4]))
...
###################################################
### code chunk number 13: Cs_060_mar2-sim
###################################################
TT=50
true.2=c(r=0,b1=-1.5,b2=-0.75,q=1)
...
###################################################
### code chunk number 15: Cs_061_mar2-sim
###################################################
...
###################################################
### code chunk number 16: Cs_07_mar2-model
###################################################
...
###################################################
### code chunk number 19: Cs_08_mar2-fit
###################################################
mar2=MARSS(sim.mar2[,2:TT],model=model.list.2m)


###################################################
### code chunk number 20: Cs_09_mar2-compare
###################################################
...
###################################################
### code chunk number 21: Cs_10_compare-mars
###################################################
...
###################################################
### code chunk number 23: Cs_11_sim-ar3-data
###################################################
TT=100
...
###################################################
### code chunk number 24: Cs_12_set-up-ar3-model
###################################################
...
###################################################
### code chunk number 25: Cs_130_fit-ar3
###################################################
ar3=MARSS(sim.ar3[3:TT],model=model.list.3)


###################################################
### code chunk number 26: Cs_131_fit-ar3
###################################################
...
###################################################
### code chunk number 28: Cs_140_fig-arss-model
###################################################
TT=1000 #set long
...
###################################################
### code chunk number 29: Cs_141_fig-arss-model
###################################################
Z=matrix(c(1,0),1,2)
B=matrix(list("b1",1,"b2",0),2,2)
U=matrix(0,2,1)
...
###################################################
### code chunk number 30: Cs_142_fig-arss-model
###################################################
ar2ss=MARSS(noisy.data,model=model.list.2ss)


###################################################
### code chunk number 31: Cs_150_fit-arss2-model
###################################################
...
###################################################
### code chunk number 32: Cs_151_fit-arss2-model
###################################################
ar2ss2=MARSS(noisy.data,model=model.list.2ss.bad)


###################################################
### code chunk number 33: Cs_153_fit-arss2-model
###################################################
...
###################################################
### code chunk number 34: Cs_16_fit-arss2-with-arima
###################################################
arima(noisy.data,order=c(2,0,2),include.mean=FALSE)


###################################################
### code chunk number 36: Cs_17_code-to-compare-arss-estimation
###################################################
...
###################################################
### code chunk number 37: Cs_18_marssperffig
###################################################
...
boxplot(t(params[c(7,1,3,5,8,2,4,6),]),names=c("AR(2)\n","MARSS\nEM","MARSS\nBFGS","ARMA\n(2,2)","AR(2)\n","MARSS\nEM","MARSS\nBFGS","ARMA\n(2,2)"),ylab="estimates of the ar coefficients",las=2)
